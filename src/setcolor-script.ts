chrome.runtime.sendMessage(
  ...
  function (response) {
    ...
    const LevelOneColorValue = hexToRgbSetColor("#9be9a8");
    const LevelTwoColorValue = hexToRgbSetColor("#40c463");
    const LevelThreeColorValue = hexToRgbSetColor("#30a14e");
    const LevelFourColorValue = hexToRgbSetColor("#216e39");
